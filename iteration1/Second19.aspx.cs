...
public partial class iteration1_Second19 : System.Web.UI.Page
{
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Session["strScore"] = Session["strScore"].ToString() + strScore.ToString();
        Response.Redirect("SecondView.aspx");
    }
}