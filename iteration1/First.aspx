            ...
            <div class="index-sec1">
                ...
                <div class="wp">
                    <ul class="clearfix">
                        <li style="width: 100%">
                            <div class="item-box">
                             <p style="width:100%;color:black"  align="left">  The Centre for Epidemiologic Studies Depression Scale (CES-D Scale) was developed for use in studies of the epidemiology of depressive symptomatology in the general population, and therefore it is a short (20 questions on the scale), structured self-report measure. The scale has high internal consistency, acceptable test-retest stability, excellent concurrent validity by clinical and self-report criteria, and substantial evidence of construct validity.
                        </p>
                                   </div>
                            <div class="item-box">
                                <div class="inner-wp" style="width: 99%">
                                    <p style="color:black">1. I was bothered by things that don’t usually bother me. </p>
