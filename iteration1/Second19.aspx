<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Second19.aspx.cs" Inherits="iteration1_Second19" %>
                    ...
                    <ul class="clearfix">
                        <li style="width: 100%">
                            ...
                            <div class="item-box">
                                ...
                                <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/images/cont1.png" Height="100px"  OnClick="ImageButton2_Click" BorderStyle="None" />
